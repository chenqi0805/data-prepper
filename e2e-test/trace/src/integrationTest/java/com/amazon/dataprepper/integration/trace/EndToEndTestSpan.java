...
public enum EndToEndTestSpan {
    ...
    EndToEndTestSpan(String traceId, String spanId, String serviceName, String parentId, String name, Span.SpanKind kind,
                     Instant endTime, Long durationInNanos, Integer statusCode) {
