...
public class OTelProtoCodecTest {
    ...
    class OTelProtoDecoderTest {
        ...
        public void testStatusAttributes() {
            ...
            assertThat(Status.StatusCode.forNumber((Integer) OTelProtoCodec.OTelProtoDecoder.getSpanStatusAttributes(st1).get(OTelProtoCodec.STATUS_CODE)), equalTo(st1.getCode()));
            ...
            assertThat(Status.StatusCode.forNumber((Integer) OTelProtoCodec.OTelProtoDecoder.getSpanStatusAttributes(st2).get(OTelProtoCodec.STATUS_CODE)), equalTo(st2.getCode()));

            assertThat(OTelProtoCodec.OTelProtoDecoder.getSpanStatusAttributes(st3).size(), equalTo(1));
            assertThat(Status.StatusCode.forNumber((Integer) OTelProtoCodec.OTelProtoDecoder.getSpanStatusAttributes(st3).get(OTelProtoCodec.STATUS_CODE)), equalTo(st3.getCode()));

            assertThat(OTelProtoCodec.OTelProtoDecoder.getSpanStatusAttributes(st4).size(), equalTo(1));
            assertThat(Status.StatusCode.forNumber((Integer) OTelProtoCodec.OTelProtoDecoder.getSpanStatusAttributes(st4).get(OTelProtoCodec.STATUS_CODE)), equalTo(st4.getCode()));
